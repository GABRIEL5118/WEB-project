...
$user_name="mytritap_root";
$password="neH;h1S(h3?_";
$name_data_base ="mytritap_trit_finalpro_db";
...
$ret=mysqli_query($con,"select * from tblsales where PageDescription='sales'");
$cnt=1;
...
$ret=mysqli_query($con,"select * from tblsales where PageDescription2='sales2' ");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
...
$ret=mysqli_query($con,"select * from tblsales where PageDescription3='sales3' ");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
